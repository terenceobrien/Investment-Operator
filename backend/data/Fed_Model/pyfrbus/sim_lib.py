...
def sim_plot(
    ...
    growth_gdp = sim[mnemonics[0]].pct_change(4) * 100
    growth_inf = sim[mnemonics[1]].pct_change(4) * 100
    base_growth_gdp = baseline[mnemonics[0]].pct_change(4) * 100
    base_growth_inf = baseline[mnemonics[1]].pct_change(4) * 100
    ...
    _single_plot(
        ...
        1,
        plot_period,
        baseline.loc[plot_period, mnemonics[2]],
        sim.loc[plot_period, mnemonics[2]],
    )
    _single_plot(
    ...
    _single_plot(
        ...
        1,
        plot_period,
        baseline.loc[plot_period, mnemonics[3]],
        sim.loc[plot_period, mnemonics[3]],
    )
    fig.tight_layout()
    plt.show()
