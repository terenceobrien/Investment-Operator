...
class TimeSeriesData:
    def __init__(self, data: DataFrame, range: Optional[PeriodIndex] = None):
        ...
        for series_name in self._data.columns:
            ...
            object.__setattr__(self, series_name, make_attr(series_name, self._data))
    ...
    def __setattr__(self, name, value):
        ...
        # Skip special attributes
            ...
            object.__setattr__(self, name, value)
        # In dataframe but not defined, i.e. added after init,
        # OR not present in either, i.e. a new variable
...
class SeriesDSL:
    ...
    def __set__(self, instance: TimeSeriesData, value: Union[float, "TimeSeriesOp"]):
        p_range: PeriodIndex = (
            instance._data.index if instance.range is None else instance.range
        )  # noqa: E501
...
class TimeSeriesOp:
    ...
    def nonrecur_eval(self, periods: Optional[Union[Period, PeriodIndex]] = None):
        if periods is None:
            ...
            periods = pandas.period_range(periods, periods, freq=periods.freqstr)
