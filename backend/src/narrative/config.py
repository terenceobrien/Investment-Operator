...
# ──────────────────────────────────────────────────────────────────────
PROMPT_VERSION: str = os.getenv("NARRATIVE_PROMPT_VERSION", "narrative_universe_memory_v2")
SOURCE_CONFIG_VERSION: str = os.getenv("NARRATIVE_SOURCE_CONFIG_VERSION", "v2")
